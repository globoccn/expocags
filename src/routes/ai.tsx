...
const diagnostics: Diagnostic[] = [
  {
    ...
    possibleCauses: ["Fluxo elevado de água gelada", "Válvula bypass aberta", "Baixa troca térmica efetiva"],
    recommendedActions: [
  ...
  },
  {
    ...
    possibleCauses: ["Pressão da linha abaixo do setpoint", "BAG2 operando por período reduzido", "Válvula bypass parcialmente aberta"],
    recommendedActions: ["Verificar operação da BAG2", "Ajustar válvula bypass do grupo Azul", "Investigar causa da baixa pressão da linha"],
  ...
  },
  {
    ...
    possibleCauses: [],
    recommendedActions: ["Manter monitoramento contínuo", "Validar leituras no próximo ciclo diário"],
    metricLabel: "Delta T médio (°C)",
    metricValue: "3,3",
...
const recentEvents = [
  { time: "06:45", text: "Delta T abaixo do esperado — Chiller Vermelho", tone: "crit" as Severity },
  { time: "05:12", text: "Pressão da linha abaixo do setpoint — Grupo Azul", tone: "warn" as Severity },
  { time: "03:18", text: "BAG2 do grupo Azul parada por baixa pressão", tone: "warn" as Severity },
  { time: "02:30", text: "Válvula bypass do grupo Vermelho aberta em 64%", tone: "warn" as Severity },
  { time: "01:22", text: "BAG3 do grupo Vermelho iniciada automaticamente", tone: "ok" as Severity },
];
    ...
    <div className="space-y-5">
      ...
      <section className="rounded-2xl border border-status-ai/45 bg-gradient-to-br from-status-ai/12 via-surface-1/70 to-background/40 p-5 shadow-[0_0_36px_rgba(168,85,247,0.12)]">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          <SummaryMetric icon={CalendarDays} label="Período analisado" value="D-1 (19/06/2026)" hint="00:00 às 23:59" tone="ai" />
          <SummaryMetric icon={AlertTriangle} label="Equipamentos em atenção" value="3" hint="de 7 monitorados" tone="warn" />
          <SummaryMetric icon={Wrench} label="Principais ocorrências" value="5" hint="eventos relevantes" tone="crit" />
          <SummaryMetric icon={ClipboardList} label="Recomendações prioritárias" value="4" hint="ações sugeridas" tone="ai" />
          <SummaryMetric icon={Database} label="Cobertura dos dados" value="98%" hint="completude do período" tone="ok" />
        </div>
      </section>
